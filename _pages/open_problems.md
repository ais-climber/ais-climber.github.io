...
## Epistemic Logic
- (TODO) Modern syllogistic logics tend to consider counting quantifiers such as `More x y`, `AtLeast x y`, and `Most x y`.  As a qualitative alternative, consider reasoning about prototypes, `Typically x y`.  What is the complete 'minimal' syllogistic logic of `Typically`?  How does it relate to `Most`?  How does it relate to conditional logics?
- 
