...
- (✨) What is the "classical model equivalent" of Iterated Hebbian Learning?  i.e. is there a dynamic update, over possible-worlds models, that is equivalent to Iterated Hebbian Learning?  What about other variants of Hebbian learning?
