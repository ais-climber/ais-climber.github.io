...
## Epistemic Logic
- () Modern syllogistic logics tend to consider counting quantifiers such as `More x y`, `AtLeast x y`, and `Most x y`.  As a qualitative alternative to `Most`, consider `Typically x y`.  What is the complete syllogistic logic of `Typically`?  How does it relate 
- 
