...
## Games
- (TODO) AlphaGo Zero can learn, via reinforcement learning and self-play, nearly any two-player turn-based game, including Go, Chess, Othello, Connect4, Tic-Tac-Toe, and more.  Recently, TODO showed that AlphaGo Zero fails to learn a winning strategy for the game [Notakto](https://en.wikipedia.org/wiki/Notakto).  What is it about Notakto that makes it challenging to learn?  See my [project notes](/alphago_misere/).
- 
- AlphaGo, which 
AlphaGo {% cite  %}