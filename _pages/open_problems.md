...
## Epistemic Logic
- (TODO) Modern syllogistic logics tend to consider counting quantifiers such as `More x y`, `AtLeast x y`, and `Most x y`.  As a qualitative alternative, consider `Typically x y`.  What is the complete syllogistic logic of `Typically`?  How does it relate to `Most`?  How does it relate to conditional logics?
- 
...
- (✨) What is the "classical equivalent" of Iterated Hebbian Learning?  i.e. is there a dynamic update, over possible-worlds models, that is equivalent to Iterated Hebbian Learning?  What about other variants of Hebbian learning?
