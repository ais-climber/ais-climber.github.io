...
- (TODO) There are many different measures of complexity for neural networks.  On the one hand, we can view different neural networks as language recognizers (CITE).  On the other, we can view a neural network architecture as models for logic, and then characterize 
