...
<\body>
  ...
  <\cv-line-4>
    Received the Robert K. Meyer Graduate Fellowship in Logic, Indiana
    University
  </cv-line-4||May 2025|>

  <\cv-line-4>
    Received the SCALE Ambassador Award, US Department of Defense
  </cv-line-4||Mar 2024|>
  ...
  <\cv-line-4>
    Received the Paul Purdom Fellowship, awarded to one outstanding PhD
    student
  ...
  <\cv-line-4>
    Received the Magellan Scholar Undergraduate Research Grant, USC Columbia
  </cv-line-4||Jan 2017|>
  ...
  <\cv-line-4>
    Seminar on Logic and Interactive Rationality (LIRa), Institute for Logic,
    Language, and

    Computation (ILLC), University of Amsterdam, Online

    <with|font-shape|italic|The Modeling Power of Neural Networks>
  </cv-line-4||Sep 2024|>
  ...
  <\cv-line-3>
    The International Florida AI Research Society Conference (FLAIRS), Jensen
    Beach, USA
  ...
  <\cv-line-4>
    ...
    in the era of Large Language Models (NucLeaR<hlink||https://nuclear-workshop.github.io/aaai2024/#page-top>)
  </cv-line-4||Nov 2023|>
  ...
  <\cv-line-4>
    Reviewer for the Journal of Logic, Language, and Information (JoLLI)
  </cv-line-4||Sep 2019|>
</body>
