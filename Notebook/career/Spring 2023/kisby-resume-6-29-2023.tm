...
<\body>
  ...
  <\cv-line|COBB: Case-Based Confidence for Black Box Predictions>
    ...
    <space|1em>network's predictions (using Scikit-Learn). (See ICCBR paper
    below.)
  ...
  <\cv-paragraph>
    <\description>
      ...
      Reasoning, Model Building, Conditional & Modal Logics, Natural Language
      Semantics>

      <item*|Languages><with|font-base-size|9pt|><with|font-base-size|9pt|><with|font-base-size|9pt|Python,
      Lean, C++, C, Java, Agda, Lisp (Racket), Haskell, Prolog>
