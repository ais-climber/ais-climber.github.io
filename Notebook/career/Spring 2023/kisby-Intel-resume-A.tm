...
<\body>
  ...
  <\cv-paragraph>
    <\description>
      ...
      Reinforcement Learning, Hebbian Learning, Tensorflow, NLP (Word2Vec,
      NLTK)>

      <item*|Symbolic AI><with|font-base-size|9pt|Knowledge Representation &
      Reasoning, Model Building, Case-Based Reasoning, Natural Language
      Semantics>

      <item*|Languages><with|font-base-size|9pt|><with|font-base-size|9pt|><with|font-base-size|9pt|Python,
      C++, C, Java, Agda, Lean, Lisp (Racket), Haskell, Prolog>
