...
<\body>
  ...
  <\cv-line|Research Assistant>
    ...
    \<circ\> See Projects below. Supported by a DoD Trusted AI grant for
    which I co-wrote the grant proposal.
  ...
  <\cv-line|à la Mode: Neural Network Model Checking & Building>
    \<circ\> Independently developed a suite for checking and building neural
    networks from symbolic constraints (using Tensorflow).
  ...
  <|cv-line>
    ...
    <space|1em>(a game for which AlphaZero fails to learn a winning strategy
    \V see the linked <hlink|Report|https://ais-climber.github.io/files/Kisby_Playing_Notakto.pdf>).
  ...
  <\cv-line|Sense-Able: Obstacle Sensor for Visually Impaired>
    ...
    \<circ\> Wrote C++ code for object detection and the front-end (in Qt);
  ...
  <\cv-paragraph>
    <\description>
      <item*|Machine Learning><with|font-base-size|9pt|Supervised &
      Reinforcement Learning, Tensorflow (Keras), Scikit-Learn, NLP
      (Word2Vec, NLTK)>

      <item*|Symbolic AI><with|font-base-size|9pt|Knowledge Representation &
      Reasoning, Model Building, Hierarchical Planning (using Pyhop)>

      <item*|Languages><with|font-base-size|9pt|><with|font-base-size|9pt|><with|font-base-size|9pt|Python,
      C++, C, Java, Agda, Lisp (Racket), miniKanren, Lean, Prolog, SQL
      (Postgres)>

      <item*|Other Tools><with|font-base-size|9pt|Numpy, Matplotlib, Pandas,
      Git, LaTeX, Jupyter Notebook (Google Colab), Visual Studio Code, Emacs,
      Linux>
    </description>
  </cv-paragraph|||>
