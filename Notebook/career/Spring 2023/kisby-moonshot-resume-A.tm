...
<\body>
  ...
  <|cv-line>
    ...
    \<circ\> Prototyped testbed code (using Tensorflow) to compare the
  ...
  <\cv-line|Sense-Able: Obstacle Sensor for Visually Impaired>
    \<circ\> Collaborated with a team to develop a protoype LIDAR sensor for
    our clients at <hlink|P. B. Mumola, Ph.D.,
  ...
  <\cv-paragraph>
    <\description>
      <item*|AI & ML><with|font-base-size|9pt|Supervised & Reinforcement
      Learning, Tensorflow (Keras), NLP (Word2Vec, NLTK), Symbolic Reasoning
      & Formal Logics>

      <item*|Programming Language Theory><with|font-base-size|9pt|Verification
      & Model Building, Functional Programming, Proof Assistants,
      Interpreters>

      <item*|Languages><with|font-base-size|9pt|><with|font-base-size|9pt|><with|font-base-size|9pt|Python,
      Agda, Lisp (Racket), C++, C, Java, Haskell, miniKanren, Prolog, Lean>
