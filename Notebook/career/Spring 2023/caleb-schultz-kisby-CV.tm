...
<\body>
  ...
  <\cv-line|Ph.D. Candidate, Computer Science (in progress)>
    ...
    Concentration: Neuro-Symbolic Learning and Reasoning
  ...
  <\cv-line>
    Notakto Player
  <|cv-line>
    \<circ\> Augmented the <hlink|AlphaZero
  ...
  <\cv-line|Sense-Able: Obstacle Sensor for Visually Impaired>
    ...
    \<circ\> Wrote core C++ code for object detection and the GUI (in Qt);
  ...
  <\cv-paragraph>
    <\description>
      <item*|Deep Learning><with|font-base-size|9pt|Supervised &
      ...
      Lean, Agda, C++, Java, Lisp (Racket), miniKanren, Prolog>
  ...
  <\cv-line-2|The Logic of Hebbian Learning>
    ...
    Beach FL.
  </cv-line-2|AAAI 2024|<cv-link|pdf|https://journals.flvc.org/FLAIRS/article/view/130735>>
