...
<\body>
  ...
  <\wide-tabular>
    <tformat|<cwith|1|1|1|-1|cell-valign|t>|<cwith|1|1|2|2|cell-halign|c>|<cwith|1|1|3|3|cell-halign|r>|<table|<row|<\cell>
      ...
      <hlink|caleb-kisby|https://www.linkedin.com/in/caleb-schultz-kisby-b2565a232/>>>>>>
    </cell>>>>
  </wide-tabular>
  ...
  <\cv-paragraph>
    <\description>
      <item*|Neural AI><with|font-base-size|9pt|Deep Learning (CNNs, LSTMs),
      Tensorflow (Keras), Scikit-Learn, NLP (Word2Vec, Natural Language
      Toolkit)>

      <item*|Symbolic AI><with|font-base-size|9pt|Knowledge Representation,
      Model Checking & Building, First-Order & Modal Logics, Natural Language
      Semantics>

      <item*|Languages><with|font-base-size|9pt|><with|font-base-size|9pt|><with|font-base-size|9pt|Python,
      C++, C, Java, Agda, Lisp (Racket), miniKanren, Lean, Prolog>
