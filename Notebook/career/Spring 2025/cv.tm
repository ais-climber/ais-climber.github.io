...
<\body>
  ...
  logic, and descriptive complexity. I'm especially interested in the
  following questions:
  ...
  <\cv-line-4>
    Epistemic logic, dynamic logics, model building, formal verification,\ 

    functional programming, logic programming
  </cv-line-4||Formal Logic:|>

  <\cv-line-4>
    Neuro-symbolic AI, machine learning, deep learning, cognitive modeling
  </cv-line-4||AI and Cogsci:|>

  <\cv-line-4>
    Python, Lean, Agda, Lisp (Racket); Tensorflow (Keras), Scikit-Learn; Git,
    LaTeX
  </cv-line-4||Programming:|>

  <\cv-line-4>
    Academic writing, presentations (talks, posters), teaching, lesson
    planning
  </cv-line-4||Soft Skills:|>
