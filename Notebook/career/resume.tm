...
<\body>
  ...
  <\cv-paragraph>
    <\description>
      <item*|AI & ML><with|font-base-size|9pt|Deep Learning (CNNs, LSTMs),
      Tensorflow (Keras), Scikit-Learn, Knowledge Representation, Symbolic
      Reasoning>

      <item*|Formal Methods><with|font-base-size|9pt|Model-Building,
      First-Order & Modal Logics, Proof Assistants, Functional Programming,
      Interpreters>

      <item*|Languages><with|font-base-size|9pt|><with|font-base-size|9pt|><with|font-base-size|9pt|Python,
      Agda, Lisp (Racket), miniKanren, Lean, Prolog, C++, C, Java>
