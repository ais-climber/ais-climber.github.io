...
<style|<tuple|tmconf|number-long-article|preview-ref>>
...
<\body>
  ...
  <\definition>
    ...
    <\equation*>
      \<varphi\>\<colons\>=i\<mid\>p\<mid\>\<neg\>\<varphi\>\<mid\>\<varphi\>\<wedge\>\<varphi\>\<mid\><value|Know>\<varphi\>\<mid\><value|Knownby>i\<mid\><value|Typ>\<varphi\>
    </equation*>
  ...
  <\definition>
    ...
    <\itemize>
      ...
      <math|w\<in\>W>, if <math|X\<cup\><around*|(|\<cap\>f<around*|(|w|)>|)><rsup|\<complement\>><rsup|>\<in\>g<around*|(|w|)>>
  ...
  <\proof>
    By induction on <math|\<varphi\>>. The nominal, propositional,
    ...
    <\description>
      ...
      <\equation*>
        ...
        >>|<cell|\<exists\>u\<in\><semantics|\<varphi\>><text| such that
        >w\<in\><value|Reach><rsup|-1><around*|(|u|)>>|<cell|<text|>>>|<row|<cell|>|<cell|iff>|<cell|<value|Net>,w\<Vdash\><value|diaKnownby>\<varphi\>>|<cell|<text|(by
        definition)>>>>>>
      </equation*>
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|X\<cup\><around*|(|\<cap\>f<around*|(|w|)>|)><rsup|\<complement\>>\<in\>g<around*|(|w|)>>.
  ...
  <\proof>
    For the <math|(\<supseteq\>)> direction, let <math|v> be such that
    ...
    <math|\<cap\>f<around*|(|v|)>\<subseteq\>S>. <math|f> is reflexive, which
    means in particular that <math|v\<in\>\<cap\>f<around*|(|v|)>\<subseteq\>S>.
    ...
    <\description>
      ...
      Since <math|f> is transitive, <math|<around*|{|t\<mid\>S<rsup|\<complement\>>\<in\>f<around*|(|t|)>|}>\<in\>f<around*|(|v|)>>.
  ...
  <\proof>
    ...
    <math|S<rsup|\<complement\>><neg|\<in\>>g<around*|(|v|)>>. Since <math|f>
    is the skeleton of <math|g>, we have <math|S<rsup|\<complement\>>\<cup\><around*|(|\<cap\>f<around*|(|v|)>|)><rsup|\<complement\>><rsup|><neg|\<in\>>g<around*|(|v|)>>,
  ...
  <\proof>
    By induction on <math|\<varphi\>>. Again, the nominal, propositional,
    <math|\<neg\>\<varphi\>>, and <math|\<varphi\>\<wedge\>\<psi\>> cases are
    trivial.
    ...
    <\description>
      ...
      <\equation*>
        ...
        Lemma <reference|lemma-Reach-and-R*>)>>>|<row|<cell|>|<cell|>|<cell|\<exists\>u\<in\><semantics|\<varphi\>><rsub|<value|Net><rsup|\<bullet\>>><text|
  ...
  <\definition>
    ...
    <\description>
      ...
      <item*|(Antisym)><math|i\<rightarrow\><value|Know><around*|(|<value|diaKnow>i\<rightarrow\>i|)>>
    ...
    <\description>
      ...
      <item*|(Name)>If <math|i\<rightarrow\>\<varphi\>\<in\><value|Logic>>
      then <math|i\<in\><value|Logic>>
    </description>
  </definition>
  ...
  <\definition>
    ...
    Moreover, a maximally consistent set <math|\<Gamma\>> is <key|named> if
    some <math|i\<in\>\<Gamma\>>.
  </definition>

  <\lemma>
    <label|lindenbaum><cite|pacuit2017neighborhood> (\PHybrid Lindenbaum's
    Lemma\Q) We can extend any set <math|\<Gamma\>> to a maximally consistent
    <with|font-shape|italic|named> set <math|\<Delta\>\<supseteq\>\<Gamma\>>.
  </lemma>

  <\proof>
    <todo|Make sure we can ensure the <with|font-shape|italic|named> part!
    i.e. we can always throw an <math|i\<in\>\<Delta\>> and remain
    consistent!>
  </proof>
  ...
  <\definition>
    ...
    is maximally consistent, named, and >\<varphi\>\<in\>\<Delta\>|}>>
  </definition>
  ...
  <\proof>
    ...
    <\equation*>
      ...
      >f>>|<row|<cell|<around*|(|<text|Asym>|)>>|<cell|<text|Proposition
      <reference|prop-reach-acyclic><todo|Check!>>>|<cell|f <text| is
      acyclic> <text|<todo|Check!>>>>|<row|<cell|<around*|(|<text|T><rsub|<value|Typ>>|)>>|<cell|<text|Inclusion
      ...
      contain the unit>>>|<row|<cell|<text|(Name)>>|<cell|<todo|>>|<cell|<todo|>>>>>>
    </equation*>
  </proof>
  ...
  <\lemma>
    ...
    <\itemize>
      ...
      is maximally consistent and named>|}>>
  ...
  <\proof>
    By induction on <math|\<varphi\>>. The nominal <todo|work this one out,
    carefully>, propositional, and boolean cases are straightforward.
  ...
  <\proof>
    ...
    <\description>
      ...
      <item*|<math|f<rsup|C>> is acyclic>Since <math|f<rsup|C>> is reflexive
      ...
      <item*|<math|f<rsup|C>> is the skeleton of <math|g<rsup|C>>><todo|Check
      \V try the contrapositive, it might be easier!>
    </description>
  ...
  <\proof>
    Extend <math|\<Gamma\>> to maximally consistent named <math|\<Delta\>>
    using Lemma <reference|lindenbaum>. Let <math|<value|Model><rsup|C>> be a
  ...
  <\itemize>
    <item>Incorporate <with|font-shape|italic|named> maximally consistent
    sets in completeness proof
...
<\references>
  <\collection>
    <associate|asymmetric-implies-acyclic|<tuple|2.7|5>>
    ...
    <associate|auto-14|<tuple|5.3|11>>
    <associate|auto-15|<tuple|5.14|14>>
    <associate|auto-16|<tuple|<with|mode|<quote|math>|\<bullet\>>|14>>
    <associate|auto-17|<tuple|A|15>>
    ...
    <associate|bib-bader2005dimensions|<tuple|1|14>>
    <associate|bib-balkenius1991nonmonotonic|<tuple|2|14>>
    <associate|bib-belle2021logic|<tuple|3|14>>
    <associate|bib-blackburn2001modal|<tuple|4|14>>
    <associate|bib-blutner2004nonmonotonic|<tuple|5|14>>
    <associate|bib-browne2001connectionist|<tuple|6|14>>
    <associate|bib-gabbay1994temporal|<tuple|7|14>>
    <associate|bib-garcez2001symbolic|<tuple|8|14>>
    <associate|bib-garcez2008neural|<tuple|9|14>>
    <associate|bib-giordano2021|<tuple|10|14>>
    <associate|bib-giordano2022conditional|<tuple|11|14>>
    <associate|bib-kautz-2020future|<tuple|12|14>>
    <associate|bib-kisby2022logic|<tuple|13|14>>
    <associate|bib-leitgeb2001nonmonotonic|<tuple|14|14>>
    <associate|bib-leitgeb2003nonmonotonic|<tuple|15|14>>
    <associate|bib-leitgeb2018neural|<tuple|16|14>>
    <associate|bib-mcculloch1943logical|<tuple|17|15>>
    <associate|bib-odense2022semantic|<tuple|18|15>>
    <associate|bib-pacuit2017neighborhood|<tuple|19|15>>
    <associate|bib-sarker2021neuro|<tuple|20|15>>
    <associate|bib-yu2021survey|<tuple|21|15>>
    <associate|canonical-knownby|<tuple|5.7|11>>
    <associate|canonical-model|<tuple|5.9|11>>
    <associate|canonical-model-is-preferential-filter|<tuple|5.12|12>>
    <associate|filter-contains-core|<tuple|2.4|5>>
    <associate|finite-model-property|<tuple|5.11|12>>
    <associate|frame-to-net|<tuple|4.7|9>>
    <associate|hash-well-defined|<tuple|4.2|8>>
    <associate|lemma-Prop-and-H*|<tuple|4.6|8>>
    <associate|lemma-Reach-and-R*|<tuple|4.5|8>>
    <associate|lindenbaum|<tuple|5.4|10>>
    <associate|max-consistent-fact|<tuple|5.6|10>>
    <associate|minimal-cause|<tuple|1.12|4>>
    <associate|model-building|<tuple|5.13|13>>
    <associate|prop-filter-consistency|<tuple|2.5|5>>
    <associate|prop-reach-acyclic|<tuple|1.11|4>>
    <associate|prop-reach-inverse|<tuple|1.10|3>>
    <associate|simulation-is-a-BFNN|<tuple|4.4|8>>
    <associate|simulation-is-preferential|<tuple|3.4|7>>
    <associate|thm-net-to-frame|<tuple|3.2|6>>
    <associate|thm:prop-props|<tuple|1.6|3>>
    <associate|thm:reach-props|<tuple|1.8|3>>
    <associate|truth-lemma|<tuple|5.10|12>>
  </collection>
</references>
