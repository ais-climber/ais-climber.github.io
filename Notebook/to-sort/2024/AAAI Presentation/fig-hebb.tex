...
\begin{tikzpicture}[loose/.style={inner sep=.7em},edge/.style = {->,-Latex},
    ...
    \node [color=gruvgreen,opacity=1, above=1.0 of $(g)!0.5!(j)$]{$\Prop(S)$};
    
    %--------------------------------------------
    % Edges
    % \draw[edge, color=black, opacity=0.2] (a) -- (f) node [near start, above] {};
    \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (a) to (f);
    ...
    \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (b) to (f);
    % \draw[edge, color=black, opacity=0.2] (b) -- (g) node [near start, above=-0.15] {};
    \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (b) to (g);
    ...
    \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (f) to (j);
    % \draw[edge, color=black, opacity=0.2] (f) -- (k) node [near start, below] {};
    \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (f) to (k);
    ...
    \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (g) to (k);
