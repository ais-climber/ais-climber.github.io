...
\begin{tikzpicture}[loose/.style={inner sep=.7em},edge/.style = {->,-Latex},
    ...
    \node [color=gruvgreen,opacity=1, above=0.9 of $(g)!0.5!(j)$]{$\Reach(S)$};
    ...
    \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (b) to [bend left] (k);
    % \draw[edge, line width=1.5pt, color=gruvgreen, opacity=0.8] (b) -- (k) node [below=-0.1, near start] {};
