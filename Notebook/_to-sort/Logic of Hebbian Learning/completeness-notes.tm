...
<\body>
  ...
  <\definition>
    ...
    <\itemize>
      ...
      <item><todo|Todo: change property again lol><math|\<cal-H\>>
      <key|extends> <math|G> whenever <math|S H v> iff
      <math|<around*|(|S\<cap\><around*|{|u\<mid\>u E v|}>|)>H v>.
    </itemize>
  </definition>

  <\proposition>
    <label|prop-hyperpath>Let <math|<with|font|cal|H>> be reflexive and
    transitive. Then <math|S<op|H<rsup|\<ast\>>>v> iff there is a strong
    hyperpath from <math|S> to <math|v> in <math|\<cal-H\>>.
  </proposition>
  ...
  <\definition>
    ...
    <\itemize>
      ...
      <item><todo|Todo: change property yet again lol><math|\<cal-G\>>
      <key|subsumes> <math|\<cal-F\>> iff for all <math|w\<in\>W>,
      <math|X\<cup\><around*|(|\<cap\>f<around*|(|w|)>|)><rsup|\<complement\>><rsup|>\<in\>g<around*|(|w|)>>
  ...
  <\proof>
    ...
    <\itemize>
      ...
      <item><todo|Todo: update proof again
      lol><with|font-series|bold|<math|<with|font|cal|G>> subsumes
  ...
  <\definition>
    ...
    and hypergraph relation <math|H<rsub|g>> by:
  ...
  <\proof>
    ...
    <\itemize>
      ...
      <math|T=<around*|{|u\<mid\>S H<rsub|g>u|}>> and <math|T H<rsub|g>v>. We
      want to show that <math|S H<rsub|g>v>. Suppose for contradiction that
      <math|\<neg\>S H<rsub|g>v>, i.e. <math|S<rsup|\<complement\>>\<in\>g<around*|(|v|)>>.
      Since <math|v\<in\>U>, <math|T H<rsub|g>v>, i.e.
      <math|T<rsup|\<complement\>><neg|\<in\>>g<around*|(|v|)>>. Note also
      ...
      <math|T<rsup|\<complement\>>\<in\>g<around|(|v|)>>. But this
      contradicts <math|T<rsup|\<complement\>><neg|\<in\>>g<around*|(|v|)>>.
      ...
      <math|R<rsub|f>>:> <todo|Todo: update proof again lol>Suppose <math|S
      H<rsub|g>v>. By definition, <math|S<rsup|\<complement\>><neg|\<in\>>g<around*|(|v|)>>.
      Since <math|<with|font|cal|G>> subsumes <with|font|cal|F>,
  ...
  <\lemma>
    <dueto|Minimal Cause>If <math|S<op|H<rsub|g>>n> then
    <math|<around*|(|S\<cap\><around*|{|u\<mid\>u<op|R<rsub|f>>n|}>|)><op|H<rsub|g>>n>
  </lemma>
  ...
  <\definition>
    Let <math|\<frak-F\>=<around|\<langle\>|W,f,g|\<rangle\>>> be a
    preferential multi-frame. Its <key|simulation net>
    <math|<Net><rsup|\<bullet\>>=<around|\<langle\>|N,E,W,A,O|\<rangle\>>> is
    the BFNN given by:
  ...
  <\proof>
    ...
    <\description>
      ...
      since we cannot have <math|<hash><rsup|-1><around|(|<hash><around|(|\<emptyset\>|)>|)>=\<emptyset\>*H<rsub|g>
      n>.
      ...
      then <math|<hash><rsup|-1><around|(|<hash><around|(|<wide|x|\<vect\>>,<wide|w<rsub|1>|\<vect\>>|)>|)><around|[|0|]><op|H<rsub|g>>n>.
      But this just means <math|<around*|{|m<rsub|i>\<mid\>x<rsub|i>=1|}>H<rsub|g>
      n>. And so <math|<hash><rsup|-1><around|(|<hash><around|(|<wide|x|\<vect\>>,<wide|w<rsub|2>|\<vect\>>|)>|)><around|[|0|]>*H<rsub|g>
  ...
  <\lemma>
    ...
    such that u<op|R<rsub|f>>v|}>>.
  </lemma>

  <\proof>
    For the <math|(\<supseteq\>)> direction, let <math|u\<in\>S> be such that
    <math|u<op|R<rsub|f>>v>. By definition of <math|E>,
    ...
    <\description>
      ...
      <math|u<op|R<rsub|f>>v>). By inductive hypothesis, there is a
      <math|t\<in\>S> such that <math|t R<rsub|f> u>. Since <math|R<rsub|f>>
      is transitive, <math|t R<rsub|f> v> as well.
    </description>
  </proof>
  ...
  <\proof>
    For the <math|(\<supseteq\>)> direction, <todo|Todo: Simplify now that we
    already have a reflexive-transitive relation.>\ 

    Suppose <math|S<op|H<rsub|g>>n>. By Lemma <todo|(Minimal Cause)>,
    <math|S\<cap\><around*|{|m<rsub|i>\<mid\>m<rsub|i><op|R<rsub|f>>n|}><op|H<rsub|g>>n>,
    i.e. <math|<around*|{|m<rsub|i>\<mid\>m<rsub|i>\<in\>S<infix-and><around*|(|m<rsub|i>,n|)>\<in\>E|}><op|H<rsub|g>>n>.

    \;

    suppose <math|S H<rsub|g> n>. By Proposition <reference|prop-hyperpath>
    there is a strong hyperpath from <math|S> to <math|n> in
    <math|H<rsub|g>>. We show that <math|n\<in\>><math|<Prop><rsub|<value|Net><rsup|\<bullet\>>><around|(|S|)>>
    ...
    <\description>
      ...
      <\equation*>
        <tabular|<tformat|<table|<row|<cell|>|<cell|S<rsub|l-1>H<rsub|g>n>|<cell|>>|<row|<cell|<around*|(|\<rightarrow\>|)>>|<cell|<around*|(|S<rsub|l-1>\<cap\><around*|{|m<rsub|i>\<mid\>m<rsub|i>R<rsub|f>n|}>|)>H<rsub|g>n>|<cell|<around*|(|by
        Lemma <todo|Todo>|)>>>|<row|<around*|(|\<rightarrow\>|)>|<cell|<around*|{|m<rsub|i>\<mid\>m<rsub|i>\<in\>S<rsub|l-1><infix-and><around*|(|m<rsub|i>,n|)>\<in\>E|}>H<rsub|g>n>|<around*|(|by
  ...
  <section*|Subtle Point about Feedforward Nets>

  I was assuming before that 'feedforward' means the net has distinct layers
  with irreflexive and antitransitive edges between layers (i.e. layer 0 and
  layer 2 will never have an edge between them).

  But Hannes (and Wikipedia) use 'feedforward' to mean
  <with|font-shape|italic|just acyclic>. Hannes' actually does make a fully
  reflexive and transitive graph for his construction. So I've been working
  with an artificial constraint all along.

  This also means that there is no need to do any reduction of
  <math|R<rsub|f>> and <math|H<rsub|g>>, and so there is no need to define
  <with|font-shape|italic|strong hyperpaths> \V instead we just work with a
  fully reflexive and transitive <math|R<rsub|f>> and <math|H<rsub|g>>.

  <with|gr-mode|<tuple|edit|arc>|gr-frame|<tuple|scale|1cm|<tuple|0.5gw|0.5gh>>|gr-geometry|<tuple|geometry|1par|0.6par>|gr-grid|<tuple|empty>|gr-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-edit-grid-aspect|<tuple|<tuple|axes|none>|<tuple|1|none>|<tuple|2|none>>|gr-edit-grid|<tuple|empty>|gr-edit-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-grid-aspect|<tuple|<tuple|axes|#e0e0ff>|<tuple|1|#e0e0ff>|<tuple|2|#e0e0ff>>|gr-grid-aspect-props|<tuple|<tuple|axes|#e0e0ff>|<tuple|1|#e0e0ff>|<tuple|2|#e0e0ff>>|gr-point-size|5ln|gr-arrow-end|\<gtr\>|gr-dash-style-unit|10ln|<graphics||<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|1.5>|<point|-5.05564572918277|2.0>>>|<with|point-size|5ln|<point|-6.55564572918277|1.5>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|2.0>|<point|-5.05564572918277|2.5>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|2.0>|<point|-5.05564572918277|2.0>>>|<with|point-size|5ln|<point|-6.55564572918277|2.0>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|2.5>|<point|-5.05564572918277|2.0>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|3.0>|<point|-5.05564572918277|2.0>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-5.05564572918277|2.0>|<point|-3.55564572918277|2.5>>>|<with|point-size|5ln|<point|-6.55564572918277|3.0>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-5.05564572918277|2.5>|<point|-3.55564572918277|2.0>>>|<with|point-size|5ln|<point|-6.55564572918277|3.5>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|4.0>|<point|-5.05564572918277|3.5>>>|<with|point-size|5ln|<point|-5.05564572918277|3.5>>|<with|point-size|5ln|<point|-3.55564572918277|3.0>>|<with|point-size|5ln|<point|-6.55564572918277|2.5>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-5.05564572918277|2.0>|<point|-3.55564572918277|2.0>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-5.05564572918277|3.0>|<point|-3.55564572918277|3.5>>>|<with|point-size|5ln|<point|-6.55564572918277|4.0>>|<with|point-size|5ln|<point|-3.55564572918277|2.0>>|<with|point-size|5ln|<point|-3.55564572918277|3.5>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|3.0>|<point|-5.05564572918277|3.5>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-5.05564572918277|2.5>|<point|-3.55564572918277|2.5>>>|<with|point-size|5ln|<point|-5.05564572918277|3.0>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-5.05564572918277|3.5>|<point|-3.55564572918277|3.0>>>|<with|point-size|5ln|<point|-3.55564572918277|2.5>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|4.0>|<point|-5.05564572918277|3.0>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|2.5>|<point|-5.05564572918277|3.0>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|3.0>|<point|-5.05564572918277|2.5>>>|<with|point-size|5ln|<point|-5.05564572918277|2.0>>|<with|point-size|5ln|<point|-5.05564572918277|2.5>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|3.5>|<point|-5.05564572918277|2.5>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<line|<point|-6.55564572918277|3.5>|<point|-5.05564572918277|3.0>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<arc|<point|-6.55565|4>|<point|-5.0|4.5>|<point|-3.55564572918277|3.5>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<arc|<point|-6.55565|3.5>|<point|-5.0|4.0>|<point|-3.55564572918277|3.0>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<arc|<point|-6.55565|4>|<point|-7.0|4.5>|<point|-6.5|4.04999162865442>>>|<with|arrow-end|\<gtr\>|dash-style-unit|10ln|<arc|<point|-5.05565|3.5>|<point|-4.5|4.0>|<point|-5.0|3.48145142360574>>>>>
  ...
  <section*|Diagrams for the poster>

  \;

  <\big-table|<tabular|<tformat|<cwith|1|1|1|-1|font-series|bold>|<twith|table-lsep|0.25em>|<twith|table-rsep|0.25em>|<twith|table-bsep|0.25em>|<twith|table-tsep|0.25em>|<cwith|1|-1|2|2|cell-lsep|1.25em>|<cwith|1|-1|2|2|cell-rsep|1.25em>|<table|<row|<cell|Syntax>|<cell|Classical
  Meaning>|<cell|Neural Network>>|<row|<cell|<with|font-series|bold|<garnet|<verbatim|p>>>>|<cell|<garnet|proposition>>|<cell|<garnet|a
  (fuzzy) set of neurons>>>|<row|<cell|<verbatim|A>
  <with|font-series|bold|<garnet|<verbatim|and>>>
  <verbatim|B>>|<cell|<verbatim|A> and <verbatim|B>>|<cell|<math|<verbatim|A>\<cup\><verbatim|B>>>>|<row|<cell|<verbatim|A
  ><with|font-series|bold|<garnet|<math|\<rightarrow\>>>><verbatim|
  B>>|<cell|<verbatim|A> implies <verbatim|B>>|<cell|<math|<verbatim|A>\<supseteq\><verbatim|B>>>>|<row|<cell|<with|font-series|bold|<garnet|<verbatim|know>>><verbatim|
  A>>|<cell|the agent <garnet|knows> <verbatim|A>>|<cell|the set of neurons
  <garnet|reachable from <verbatim|A>>>>|<row|<cell|<with|font-series|bold|<garnet|<verbatim|typ>>><verbatim|
  A>>|<cell|<garnet|typically> <verbatim|A>>|<cell|the set of neurons
  <garnet|activated by <verbatim|A>>>>|<row|<cell|<verbatim|A
  ><with|font-series|bold|<garnet|<math|\<Rightarrow\>>>><verbatim|
  B>>|<cell|<verbatim|typ A ><math|\<rightarrow\>><verbatim| B>>|<cell|on
  input <verbatim|A> the net <garnet|predicts>
  <verbatim|B>>>|<row|<cell|<verbatim|[><with|font-series|bold|<garnet|<verbatim|hebb>>><verbatim|
  A] B>>|<cell|<garnet|incremental pref upgrade> on
  <verbatim|A>>|<cell|<garnet|learn <verbatim|A>>
  (Hebbian)>>|<row|<cell|<verbatim|[><with|font-series|bold|<garnet|<verbatim|hebb*>>><verbatim|
  A] B>>|<cell|<garnet|preference upgrade> on
  <verbatim|A>>|<cell|<garnet|repeatedly learn <verbatim|A>> (Hebbian)>>>>>>
    \;
  </big-table>

  <math|<rsup|\<dagger\>>>we can similarly define
  <verbatim|[><with|font-series|bold|<garnet|<verbatim|backprop>>><verbatim|
  A] B>\ 

  <space|1em>for backpropagation

  \;

  <math|<rsup|\<dagger\>\<dagger\>>>the 'flipped' semantics (with
  <verbatim|and> as <math|\<cap\>>, <math|\<rightarrow\>> as
  <math|\<subseteq\>>,\ 

  <space|1em>dual modalities) is equivalent

  \;

  <with|font-series|bold|Basic Modal Axioms>

  <verbatim|know A <math|\<rightarrow\>> A>

  <verbatim|know A <math|\<rightarrow\>> know know A>

  <verbatim|typ A <math|\<rightarrow\>> A>

  <verbatim|typ A <math|\<rightarrow\>> typ typ A>

  <verbatim|know A <math|\<rightarrow\>> typ A>

  \;

  <with|font-series|bold|Monotonicity Axioms>

  <verbatim|know (A <math|\<rightarrow\>> B) <math|\<rightarrow\>> (know A
  <math|\<rightarrow\>> know B)>

  <verbatim|(typ A1 <math|\<rightarrow\>> A2)> <text-dots> <verbatim|(typ An
  <math|\<rightarrow\>> A1) <math|\<rightarrow\>> >

  <space|1em><verbatim|(typ Ai <math|\<leftrightarrow\>> Aj)>

  \;

  <with|font-series|bold|Induction Axioms>

  <verbatim|[hebb* A] B <math|\<rightarrow\>> B and [hebb A][hebb* A] B>

  <verbatim|[hebb* A](B <math|\<rightarrow\>> [hebb A] B)
  <math|\<rightarrow\>> [hebb* A] B>

  \;

  <with|font-series|bold|What The Net Learns>

  <verbatim|[hebb* A] typ B> <math|\<leftrightarrow\>>\ 

  <space|3em><choice|<tformat|<table|<row|<cell|<very-large|<garnet|<verbatim|<with|font-series|bold|typ
  [hebb* A] B>>>>>>|<row|<cell|<space|3em><very-large|if <verbatim|typ A or
  typ B> is <math|\<emptyset\>>>>>|<row|<cell|<very-large|<verbatim|<very-large|<garnet|<verbatim|<with|font-series|bold|typ
  [hebb* A] B and>>>>>>>>|<row|<cell|<space|3em><very-large|<with|font-series|bold|<garnet|<verbatim|(typ
  A or know B)>>>>>>|<row|<cell|<space|3em><very-large|otherwise>>>>>>

  \;

  <subsection*|Minimal Cause follows from the other properties>

  <\proposition*>
    If <math|S<op|H<rsub|g>>n>, then <math|S\<cap\><around*|{|u\<mid\>u<op|R<rsub|f>>n|}><op|H<rsub|g>>n>.
  </proposition*>

  <\proof>
    Suppose <math|S<op|H<rsub|g>>n>. So there exists a strong hyperpath from
    <math|S> to <math|n> in <math|H<rsub|g><rsup|->>, the
    reflexive-transitive reduction of <math|H<rsub|g>>. We proceed by
    induction on the length of this path.

    <\description>
      <item*|Base Step>We have hyperpath <math|<around*|(|S|)>>, with
      <math|n\<in\>S>. Since <math|R<rsub|f>> is reflexive,
      <math|n<op|R<rsub|f>>n>. So <math|n\<in\>S\<cap\><around*|{|u\<mid\>u<op|R<rsub|f>>n|}>>.
      Since <math|H<rsub|g>> is reflexive,
      <math|S\<cap\><around*|{|u\<mid\>u<op|R<rsub|f>>n|}><op|H<rsub|g>>n>.

      <item*|Inductive Step>We have <math|<around*|(|S,\<ldots\>,S<rsub|l-1>,S<rsub|l>|)>>,
      with <math|n\<in\>S<rsub|l>>. By definition,
      <math|S<rsub|l>=<around*|{|u\<mid\>S<rsub|l-1><op|H<rsub|g>>u|}>>. In
      particular, <math|S<rsub|l-1><op|H<rsub|g>>n>. Well, for all
      <math|v\<in\>S<rsub|l-1>>, <math|S<rsub|><op|H<rsub|g>>v> (via the
      hyperpath <math|<around*|(|S,\<ldots\>,S<rsub|l-1>|)>>). By inductive
      hypothesis, for all such <math|v>, <math|S\<cap\><around*|{|u\<mid\>u<op|R<rsub|f>>v|}><op|H<rsub|g>>v>.
      Since <math|H<rsub|g>> is transitive,
      <math|S\<cap\><around*|{|u\<mid\>u<op|R<rsub|f>>v|}><op|H<rsub|g>>n>.
      <todo|Whoops, this isn't exactly our conclusion<text-dots> :(>
    </description>
  </proof>

  <section*|Nice Properties a Neural Net Could Have>

  I'd like to do <with|font-series|bold|model checking> for neural networks
  (formally verified in Lean). I have two use cases in mind: (1) Proving that
  a learning algorithm has a certain property (a
  <with|font-series|bold|soundness check> for that operator), and (2) Proving
  that a specific special neural network behaves nicely (a
  <with|font-series|bold|model check> for that net). (1) is more interesting,
  but (2) is easier to automate.

  <\itemize>
    <item><with|font-series|bold|[Soundness Check]> Supervised learning can
    be simulated by Unsupervised learning

    <math|<around*|[|P;Q|]><rsup|\<ast\>>R\<leftrightarrow\><around*|(|<around*|[|P|]>\<ldots\>R\<ldots\>|)>\<ldots\><around*|(|<around*|[|Q|]>\<ldots\>R\<ldots\>|)>>

    <item><with|font-series|bold|[Model Check]> The net's learning preserves
    a specific prediction (say: an email AI should never generate profanity)

    <math|\<neg\><around*|(|dear\<Rightarrow\>fucknugget|)>\<rightarrow\><around*|[|D|]>\<neg\><around*|(|dear\<Rightarrow\>fucknugget|)>>

    <item><with|font-series|bold|[Soundness Check]> The net converges (and we
    can express what belief it converges to):

    <math|<around*|[|P|]><rsup|\<ast\>>Q\<leftrightarrow\>>some static
    formula involving <math|P> and <math|Q>

    i.e. we can reduce <math|<around*|[|P|]><rsup|\<ast\>>Q> to the base
    language\ 

    (we have this for Hebbian learning)

    <item><with|font-series|bold|[Soundness Check]>
    <math|<around*|[|P<rsub|1>\<wedge\>\<ldots\>\<wedge\>P<rsub|n>|]><rsup|\<ast\>>Q\<leftrightarrow\><around*|[|P<rsub|1>|]><rsup|\<ast\>>\<ldots\><around*|[|P<rsub|n>|]><rsup|\<ast\>>Q>

    <item><with|font-series|bold|[Soundness Check]> In the limit, the order
    of training inputs doesn't matter:

    <math|<around*|[|P|]><rsup|\<ast\>><around*|[|Q|]><rsup|\<ast\>>R\<leftrightarrow\><around*|[|Q|]><rsup|\<ast\>><around*|[|P|]><rsup|\<ast\>>R>

    (I think we have this for Hebbian learning)
  </itemize>
  ...
  <section*|Updates for Meeting, 12/13>

  <\itemize>
    <item>Upcoming conference deadlines:

    <\description>
      <item*|IJCAI>Abstract: Jan 11; Full paper: Jan 18

      <item*|KR>March 14

      <item*|NeurIPS>Usually May

      \;
    </description>

    <item>Upcoming workshop deadlines:

    <\description>
      <item*|WoLLIC>Feb 27<space|1em><garnet|[Is this a good fit?]>

      <item*|NeSy>March 13<space|1em><garnet|[I know this is a great fit
      here]>
    ...
    <\itemize>
      <item>The beginnings of an Agda library for verifying neural networks

      <item>Given a binary feed-forward net, build a classical model
      (soundness)

      <item>A complete description of <verbatim|[hebb*]>

      \;
    </itemize>

    <item>Things I can try (1 month!!!):

    <\itemize>
      <item>Finish the Agda library<space|1em><garnet|[Easy but takes time!]>

      <\itemize>
        <item>To be practical, needs to allow for fuzzy-valued nets

        <item>To be practical, needs to hook into Pytorch

        <item>Come up with a realistic example of a property to verify
      </itemize>

      <item>Extend soundness for fuzzy + probabilistic set
      interpretations<space|1em><garnet|[Unsure how hard!]>

      <item>Extend soundness for backpropagation<space|1em><garnet|[Hard!]>

      <item>Try to get completeness for binary, feed-forward
      nets<space|1em><garnet|[Hard, but I'm so close!]>

      <item>Try to get complete description of <verbatim|[hebb]> (single-step
      <verbatim|[hebb*]>)<space|1em><garnet|[Unsure how hard!]>

      \;
    </itemize>

    <item>Any one of these would make for a good workshop paper, but need
    more for a conference
  </itemize>
  ...
  <section*|Current Projects (Just do them!!!):>

  <\description>
    <item*|[Arxiv Paper]>Sizes paper, but with all the proofs set in (minimal
    Python code???).

    <item*|[Arxiv Paper]>Hebbian learning paper, but with all the proofs set
    in.

    <item*|[Journal Paper]>Sizes paper, with all the proofs in. Think
    carefully about integrating <math|\<cup\>> and \<cap\>, or possibly
    getting completeness for More.

    <item*|[Conference Paper]>Doing case-adaptation on a neural network's
    predicted case, with Larry Gates.

    <item*|[Workshop Paper]>Show that we can straightforwardly extend logic
    of binary nets to logic of fuzzy nets (depends on how difficult this
    is<text-dots>). Try doing probabilistic interpretation as well.

    <item*|[Conference Paper]>Modal logic of feed-forward static nets, with
    <math|<value|Know>,<value|Typ>>. Model-building, completeness, fuzzy
    nets. Reason for re-doing Hannes' stuff in modal logic is to model
    learning, so include some properties of learning operators (e.g.
    <verbatim|[hebb*]> and <verbatim|[hebb_stable*]>).

    <item*|[Journal Paper]>Hebbian Learning as Preference Upgrade. Everything
    from previous paper, but with complete laws for <verbatim|[hebb*]> and
    <verbatim|[hebb_stable*]>, as well as <verbatim|[hebb]> and
    <verbatim|[hebb_stable]>.

    Also check if <verbatim|[op* A1 <text-dots> An] P = ([op
    A1]<text-dots>[op An])* P>

    Relate to Preference Upgrade operators.

    <item*|[Conference Paper]>The Logic of Backprop. Full fuzzy logic with
    <verbatim|[backprop*]> and <verbatim|[backprop]>. Check relationship
    between <verbatim|[hebb_stable*]> and <verbatim|[backprop*]>.

    Also check if <verbatim|[backprop* A1 <text-dots> An] P = ([backprop
    A1]<text-dots>[backprop An])* P>

    <item*|[Conference Paper]>Consider logic of
    <math|<value|Know>,<value|Typ>> for RNNs. LSTMs; Transformer Models.
    Relate to work on non-transitive preference relations. Relate to Hannes'
    Inhibition Nets II.

    <item*|[Workshop Paper]>Workshop the Agda suite to an audience that would
    appreciate it. Advertise verified learning, not just verified static nets
    (after the fact). Get people's opinions on features, what would help
    them.

    <item*|[Conference Paper]>Announce the Agda suite, with everything fully
    set-in! Include things we can practically verify in this language,
    including examples from

    <slink|https://verifieddeeplearning.com/>
  </description>
  ...
  <\itemize>
    ...
    <item>Check relationship between any <verbatim|[op*]> and its
    single-iteration <verbatim|[op]>

    <item>Check if <verbatim|[op* A1 <text-dots> An] P = ([op
    A1]<text-dots>[op An])* P>

    The LHS is what our axioms let us reduce (what have reduction laws for)

    The RHS is what is done in practice (repeated iteration over a dataset
    <verbatim|A1<text-dots>An> in practice)
  </itemize>
</body>
...
<\references>
  <\collection>
    ...
    <associate|auto-10|<tuple|4|11>>
    <associate|auto-11|<tuple|5|16>>
    <associate|auto-12|<tuple|6|16>>
    <associate|auto-13|<tuple|6|16>>
    <associate|auto-14|<tuple|3|16>>
    <associate|auto-15|<tuple|3|17>>
    <associate|auto-16|<tuple|1|17>>
    <associate|auto-17|<tuple|1|18>>
    <associate|auto-18|<tuple|Inductive Step|18>>
    <associate|auto-19|<tuple|<with|mode|<quote|math>|\<bullet\>>|19>>
    <associate|auto-2|<tuple|1.1|1>>
    <associate|auto-20|<tuple|<with|mode|<quote|math>|\<bullet\>>|20>>
    <associate|auto-3|<tuple|1.2|3>>
    <associate|auto-4|<tuple|1.3|4>>
    <associate|auto-5|<tuple|1.4|5>>
    <associate|auto-6|<tuple|1.5|6>>
    <associate|auto-7|<tuple|1.6|8>>
    <associate|auto-8|<tuple|2|8>>
    <associate|auto-9|<tuple|3|9>>
    <associate|bib-leitgeb2001nonmonotonic|<tuple|1|16>>
    <associate|bib-pacuit2017neighborhood|<tuple|2|16>>
    <associate|bib-thakur2009linear|<tuple|3|16>>
    <associate|lemma-Prop-and-H*|<tuple|4.11|14>>
    <associate|lemma-Reach-and-R*|<tuple|4.10|14>>
    <associate|prop-H*-and-g|<tuple|4.5|13>>
    <associate|prop-R*-and-f|<tuple|4.4|13>>
    <associate|prop-filter-consistency|<tuple|1.29|7>>
    <associate|prop-hyperpath|<tuple|1.21|6>>
    <associate|prop-reach-inverse|<tuple|1.8|3>>
    <associate|thm:prop-props|<tuple|1.9|3>>
...
<\auxiliary>
  <\collection>
    ...
    <\associate|toc>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-shape|<quote|small-caps>|Subtle
      Point about Feedforward Nets> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <pageref|auto-14><vspace|0.5fn>

      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-shape|<quote|small-caps>|Diagrams
      for the poster> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <pageref|auto-15><vspace|0.5fn>

      <with|par-left|<quote|1tab>|Minimal Cause follows from the other
      properties <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-17>>

      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-shape|<quote|small-caps>|Nice
      Properties a Neural Net Could Have>
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <pageref|auto-18><vspace|0.5fn>

      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-shape|<quote|small-caps>|Updates
      for Meeting, 12/13> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <pageref|auto-19><vspace|0.5fn>

      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-shape|<quote|small-caps>|Current
      Projects (Just do them!!!):> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
