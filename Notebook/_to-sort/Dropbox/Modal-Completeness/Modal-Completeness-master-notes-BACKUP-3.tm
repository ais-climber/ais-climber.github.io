...
<\body>
  ...
  <\definition>
    ...
    directed graph <math|<value|Net>=\<langle\>N,E,W,A,O,V\<rangle\>>, where
  ...
  <\definition>
    ...
    <math|<value|Net>=\<langle\>N,E,W,A,O,V\<rangle\>> that is
    ...
    <\itemize>
      ...
      <key|zero at zero> in the first parameter:
      <math|O<rsup|<around*|(|n|)>><around*|(|A<rsup|<around*|(|n|)>><around*|(|<wide|0|\<vect\>>,<wide|w|\<vect\>>|)>|)>=0>

      <item><math|O<rsup|<around*|(|n|)>>\<circ\> A<rsup|<around*|(|n|)>>> is
      <key|strictly monotonically increasing> in the second parameter: for
      all <math|<wide|x|\<vect\>>,<wide|w<rsub|>|\<vect\>><rsub|1>,<wide|w|\<vect\>><rsub|2>\<in\>
  ...
  <\proposition>
    <label|Reach-paths><with|font-series|bold|(Alternate characteriz. of
    <math|<value|Reach>>)> Let <math|n\<in\>N>, <math|S\<in\><value|Set>>.
    Then <math|n\<in\><value|Reach><around*|(|S|)>> iff there is a path from
    some <math|m\<in\>S> to <math|n> in <math|E>.
  </proposition>
  ...
  <\proposition>
    ...
    <\description>
      ...
      <item*|<key|(Acyclic)>>If <math|S<rsub|1>\<subseteq\><value|Reach><around*|(|S<rsub|2>|)>>
      and <math|S<rsub|2>\<subseteq\><value|Reach><around*|(|S<rsub|1>|)>>
      then <math|S<rsub|1>=S<rsub|2>>.
  ...
  <\proof>
    ...
    <\description>
      <item*|(Inclusive)>If <math|n\<in\>S>, then
      <math|n\<in\><value|Reach><around|(|S|)>> by the base case of
      <value|Reach>.
      ...
      and proceed by induction on the outer <math|<value|Reach>>.

      <\description>
        <item*|Base Step><math|n\<in\><value|Reach><around*|(|S|)>>, and so
        we are done.

        <item*|Inductive Step>There is an
        <math|m\<in\><value|Reach><around*|(|<value|Reach><around*|(|S|)>|)>>
        such that <math|<around*|(|m,n|)>\<in\>E>. by inductive hypothesis,
        <math|m\<in\><value|Reach><around*|(|S|)>>. And so by definition,
        <math|n\<in\><value|Reach><around*|(|S|)>>.
      </description>

      <item*|(Acyclic)>Suppose <math|S<rsub|1>\<subseteq\><value|Reach><around*|(|S<rsub|2>|)>>
      and <math|S<rsub|2>\<subseteq\><value|Reach><around*|(|S<rsub|1>|)>>.
      We will show <math|S<rsub|1>\<subseteq\>S<rsub|2>> (the other direction
      is similar). <todo|Todo>

      <item*|(Monotonic)>Let <math|n\<in\><Reach><around|(|S<rsub|1>|)>>. We
      proceed by induction on <math|<Reach><around|(|S<rsub|1>|)>>.
  ...
  <\proposition>
    ...
    <\description>
      <item*|<key|(Inclusive)>><math|S\<subseteq\><Prop><around|(|S|)>>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\description>
        ...
        Since <math|O\<circ\>A> is zero at zero, we have
  ...
  <\proposition>
    The Cumulative and Loop properties from
    <math|<cite|leitgeb2001nonmonotonic>> <todo|The KLM Cumulative & Loop
    properties, actually>, i.e.
    ...
    follow from the properties of <math|<value|Prop>> and
    <math|<value|Reach>> above.
  </proposition>

  <\proof>
    <todo|Todo \U note that (Cumulative) actually follows from (Loop). Use
    acyclic property of <math|<value|Reach>> to get (Loop)>
  </proof>
  ...
  <\equation*>
    <tabular|<tformat|<cwith|1|2|2|2|cell-lsep|1em>|<cwith|1|2|2|2|cell-rsep|1em>|<cwith|2|2|1|3|cell-tborder|0ln>|<cwith|1|1|1|-1|cell-tborder|0ln>|<cwith|2|2|1|-1|cell-bborder|0ln>|<cwith|1|-1|1|1|cell-lborder|0ln>|<cwith|1|-1|3|3|cell-rborder|0ln>|<table|<row|<cell|<value|Model>,w\<Vdash\><value|diaKnow>\<varphi\>>|<cell|iff>|<cell|<around*|{|u
  ...
  <\lemma>
    ...
    <\equation*>
      <value|Activ><rsub|S><around*|(|<wide|m|\<vect\>>,n|)>=1<infix-iff><around*|{|m<rsub|i>\<mid\>m<rsub|i>\<in\>S|}><rsup|\<complement\>><neg|\<in\>>g<around*|(|n|)>
    </equation*>
  </lemma>
  ...
  <\proof>
    ...
    and by the constructor of <math|<value|Reach>>,
  ...
  <\proof>
    For the <math|(\<supseteq\>)> direction, suppose
    <math|S<rsup|\<complement\>><neg|\<in\>>g<around*|(|n|)>>.\ 

    <todo|Check for a counterexample by computer!>
    ...
    and so by the constructor of <math|<value|Prop>>,
  ...
  <\definition>
    ...
    <\description>
      ...
      <item*|(<value|Know>-<value|Typ>)><math|<value|Know>\<varphi\>\<rightarrow\><value|Typ>\<varphi\>>
    </description>
    ...
    <\description>
      ...
      <math|\<box\>\<in\><around*|{|<value|Know>,<value|Typ>|}>>
    </description>
  </definition>
  ...
  <\lemma>
    ...
    (\PLindenbaum's Lemma\Q) We can extend any set <math|\<Gamma\>> to a
    maximally consistent set <math|\<Delta\>\<supseteq\>\<Gamma\>>.
  </lemma>
  ...
  <\proposition>
    ...
    and let <math|\<box\>\<in\><around*|{|<value|Know>,<value|Typ>|}>>. We
    have <math|\<box\>\<varphi\>\<in\>\<Delta\>> iff
  ...
  <\proof>
    ...
    <\equation*>
      ...
      filter>>>|<row|<cell|<around*|(|<text|T><rsub|<value|Know>>|)>>|<cell|<text|Inclusion
      ...
      >g>>|<row|<cell|<around*|(|<text|<value|Typ>>-<value|Know>|)>>|<cell|<value|Reach><text|
      contains ><value|Prop>>|<cell|g<text| contains>
      f>>|<row|<cell|<text|(Necessitation)>>|<cell|\<forall\>w,w<neg|\<in\>><value|Reach><around*|(|\<emptyset\>|)>,<value|Prop><around*|(|\<emptyset\>|)>>|<cell|f,g<text|
      contain the unit>>>>>>
    </equation*>
  </proof>
  ...
  <\proof>
    ...
    <\description>
      ...
      <math|<around*|\||\<varphi\>|\|><rsub|<value|Logic>>\<in\>f<rsup|C><around*|(|\<Delta\>|)>>.
      By definition of <math|f<rsup|C>>, <math|<value|Know>\<varphi\>\<in\>\<Delta\>>.
      By the <math|<around*|(|<value|Know>-<value|Typ>|)>> axiom,
      <math|<value|Typ>\<varphi\>\<in\>\<Delta\>>. And so
      <math|<around*|\||\<varphi\>|\|><rsub|<value|Logic>>\<in\>f<rsup|C><around*|(|\<Delta\>|)>>.
    </description>
...
<\references>
  <\collection>
    <associate|Reach-paths|<tuple|1.9|3|Modal-Completeness-master-notes.tm>>
    <associate|activates-to-g|<tuple|4.4|8|Modal-Completeness-master-notes.tm>>
    <associate|activation-agrees|<tuple|1.6|3|Modal-Completeness-master-notes.tm>>
    <associate|asymmetric-implies-acyclic|<tuple|2.6|6|Modal-Completeness-master-notes.tm>>
    <associate|auto-1|<tuple|<with|mode|<quote|math>|\<bullet\>>|2|Modal-Completeness-master-notes.tm>>
    <associate|auto-10|<tuple|4|8|Modal-Completeness-master-notes.tm>>
    <associate|auto-11|<tuple|5|10|Modal-Completeness-master-notes.tm>>
    <associate|auto-12|<tuple|5.1|10|Modal-Completeness-master-notes.tm>>
    <associate|auto-13|<tuple|5.2|11|Modal-Completeness-master-notes.tm>>
    <associate|auto-14|<tuple|5.3|11|Modal-Completeness-master-notes.tm>>
    <associate|auto-15|<tuple|5.13|13|Modal-Completeness-master-notes.tm>>
    <associate|auto-16|<tuple|<with|mode|<quote|math>|\<bullet\>>|13|Modal-Completeness-master-notes.tm>>
    <associate|auto-17|<tuple|A|14|Modal-Completeness-master-notes.tm>>
    <associate|auto-2|<tuple|1|2|Modal-Completeness-master-notes.tm>>
    <associate|auto-3|<tuple|1.1|2|Modal-Completeness-master-notes.tm>>
    <associate|auto-4|<tuple|1.2|3|Modal-Completeness-master-notes.tm>>
    <associate|auto-5|<tuple|1.3|4|Modal-Completeness-master-notes.tm>>
    <associate|auto-6|<tuple|2|5|Modal-Completeness-master-notes.tm>>
    <associate|auto-7|<tuple|2.1|5|Modal-Completeness-master-notes.tm>>
    <associate|auto-8|<tuple|2.2|6|Modal-Completeness-master-notes.tm>>
    <associate|auto-9|<tuple|3|6|Modal-Completeness-master-notes.tm>>
    <associate|bib-bader2005dimensions|<tuple|1|13|Modal-Completeness-master-notes.tm>>
    <associate|bib-balkenius1991nonmonotonic|<tuple|2|13|Modal-Completeness-master-notes.tm>>
    <associate|bib-belle2021logic|<tuple|3|13|Modal-Completeness-master-notes.tm>>
    <associate|bib-blackburn2001modal|<tuple|4|13|Modal-Completeness-master-notes.tm>>
    <associate|bib-blutner2004nonmonotonic|<tuple|5|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-browne2001connectionist|<tuple|6|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-gabbay1994temporal|<tuple|7|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-garcez2001symbolic|<tuple|8|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-garcez2008neural|<tuple|9|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-giordano2021|<tuple|10|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-giordano2022conditional|<tuple|11|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-kautz-2020future|<tuple|12|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-kisby2022logic|<tuple|13|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-leitgeb2001nonmonotonic|<tuple|14|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-leitgeb2003nonmonotonic|<tuple|15|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-leitgeb2018neural|<tuple|16|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-mcculloch1943logical|<tuple|17|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-odense2022semantic|<tuple|18|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-pacuit2017neighborhood|<tuple|19|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-sarker2021neuro|<tuple|20|14|Modal-Completeness-master-notes.tm>>
    <associate|bib-yu2021survey|<tuple|21|14|Modal-Completeness-master-notes.tm>>
    <associate|canonical-model|<tuple|5.8|11|Modal-Completeness-master-notes.tm>>
    <associate|canonical-model-is-preferential-filter|<tuple|5.11|12|Modal-Completeness-master-notes.tm>>
    <associate|filter-contains-core|<tuple|2.4|5|Modal-Completeness-master-notes.tm>>
    <associate|finite-model-property|<tuple|5.10|12|Modal-Completeness-master-notes.tm>>
    <associate|frame-to-net|<tuple|4.8|9|Modal-Completeness-master-notes.tm>>
    <associate|hash-well-defined|<tuple|4.2|8|Modal-Completeness-master-notes.tm>>
    <associate|lemma-Prop-and-H*|<tuple|4.7|9|Modal-Completeness-master-notes.tm>>
    <associate|lemma-Reach-and-R*|<tuple|4.6|9|Modal-Completeness-master-notes.tm>>
    <associate|lindenbaum|<tuple|5.4|10|Modal-Completeness-master-notes.tm>>
    <associate|max-consistent-fact|<tuple|5.6|10|Modal-Completeness-master-notes.tm>>
    <associate|model-building|<tuple|5.12|13|Modal-Completeness-master-notes.tm>>
    <associate|simulation-is-a-BFNN|<tuple|4.5|8|Modal-Completeness-master-notes.tm>>
    <associate|simulation-is-preferential|<tuple|3.4|7|Modal-Completeness-master-notes.tm>>
    <associate|thm-net-to-frame|<tuple|3.2|6|Modal-Completeness-master-notes.tm>>
    <associate|thm:prop-props|<tuple|1.11|4|Modal-Completeness-master-notes.tm>>
    <associate|thm:reach-props|<tuple|1.10|3|Modal-Completeness-master-notes.tm>>
    <associate|truth-lemma|<tuple|5.9|11|Modal-Completeness-master-notes.tm>>
  </collection>
</references>
