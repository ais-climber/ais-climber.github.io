...
<\body>
  ...
  <\definition>
    ...
    <\itemize>
      ...
      <item><math|A<rsup|<around*|(|n|)>>> is <key|monotonically increasing>
      in the second parameter: for all <math|<wide|x|\<vect\>>,<wide|w<rsub|>|\<vect\>><rsub|1>,<wide|w|\<vect\>><rsub|2>\<in\>
      <with|font|Bbb|R><rsup|k>>, if <math|<wide|w<rsub|>|\<vect\>><rsub|1>\<less\><wide|w|\<vect\>><rsub|2>>
      then <math|A<rsup|<around*|(|n|)>><around*|(|<wide|x|\<vect\>>,<wide|w|\<vect\>><rsub|1>|)>\<less\>A<rsup|<around*|(|n|)>><around*|(|<wide|x|\<vect\>>,<wide|w|\<vect\>><rsub|2>|)>>.
      We will more often refer to the equivalent condition:

      <\equation*>
        <wide|w<rsub|>|\<vect\>><rsub|1>\<leqslant\><wide|w|\<vect\>><rsub|2><infix-iff>A<rsup|<around*|(|n|)>><around*|(|<wide|x|\<vect\>>,<wide|w|\<vect\>><rsub|1>|)>\<leqslant\>A<rsup|<around*|(|n|)>><around*|(|<wide|x|\<vect\>>,<wide|w|\<vect\>><rsub|2>|)>
      </equation*>
    </itemize>
  </definition>
  ...
  <\proposition>
    <label|graph-reach><math|<value|Reach><around*|(|S|)>=<around*|{|n\<mid\>\<exists\>m\<in\>S<text|
  ...
  <\proof>
    We check each in turn: <todo|It may be easier to just define
    <math|<value|Reach>> in terms of paths, rather than recursively.>
    ...
    <\description>
      ...
      Proposition <reference|graph-reach>, there is an <math|E>-path from
  ...
  <\proposition>
    ...
    <\equation*>
      <value|Reachedby><around*|(|T|)>\<subseteq\><value|Prop><around*|(|S|)><infix-iff><value|Reachedby><around*|(|T|)>\<subseteq\><value|Prop><around*|(|<value|Prop><around*|(|S|)>\<cap\><value|Reachedby><around*|(|T|)>|)>
    </equation*>
  </proposition>
  ...
  <\proof>
    ...
    Take a minute to notice that this implies <with|font-series|bold|(Minimal
    Cause)>. So let's prove it. Suppose <math|n\<in\><value|Reachedby><around*|(|T|)>>.
  ...
  <\proof>
    ...
    <\description>
      ...
      <item*|<math|O<rsup|<around|(|n|)>>\<circ\>A<rsup|<around|(|n|)>>> is
      monotonically increasing>Notice that the actual value of
      <math|A<rsup|<around*|(|v|)>><around*|(|<wide|x|\<vect\>>,<wide|w|\<vect\>>|)>>
      does not depend at all on <math|<wide|w|\<vect\>>>. So if we have
      <math|<wide|w|\<vect\>><rsub|1>,<wide|w|\<vect\>><rsub|2>> such that
      <math|<wide|w|\<vect\>><rsub|1>\<less\><wide|w|\<vect\>><rsub|2>>, then
      we trivially have <math|A<rsup|<around*|(|v|)>><around*|(|<wide|x|\<vect\>>,<wide|w|\<vect\>><rsub|1>|)>\<less\>A<rsup|<around*|(|v|)>><around*|(|<wide|x|\<vect\>>,<wide|w|\<vect\>><rsub|2>|)>>
      <todo|Not quite true, use partial inclusion?>.
    </description>
  </proof>
  ...
  <\definition>
    ...
    <\description>
      ...
      <item*|(Skel)><math|<around*|(|<value|Typ>\<varphi\>\<rightarrow\><value|Knownby>\<psi\>|)>\<leftrightarrow\><around*|(|<value|Typ><around*|(|<value|Typ>\<varphi\>\<vee\><value|Knownby>\<psi\>|)>\<rightarrow\><value|Knownby>\<psi\>|)>>
    </description>
  ...
  <\proof>
    ...
    <\equation*>
      ...
      >f>>|<row|<cell|<text|<around*|(|Grz|)>>>|<cell|<text|Antisymmetry of
      <value|Reach>>>|<cell|f<text| is antisymmetric>>>|<row|<cell|<around*|(|<text|K>\<leftarrow\>|)>>|<cell|<text|Definition
      of ><value|Reachedby>>|<cell|<text|Definition of
      ><value|Knownby>>>|<row|<cell|<around*|(|<text|Back>|)>>|<cell|<text|Monotonicity
      of ><value|Reach>>|<cell|\<langle\>W,f\<rangle\><text| forms a
      filter>>>|<row|<cell|<around*|(|<text|Forth>|)>>|<cell|<text|Monotonicity
      of ><value|Reach>>|<cell|\<langle\>W,f\<rangle\><text| forms a
      filter>>>|<row|<cell|<around*|(|<text|4><rsub|<value|Typ>>|)>>|<cell|<text|Idempotence
      ...
      f>>|<row|<cell|<around*|(|<text|Skel>|)>>|<cell|<text|Minimal
      Cause>>|<cell|f<text| is a skeleton of
  ...
  <\proof>
    ...
    <\description>
      ...
      But this contradicts the (Grz) axiom
...
<\references>
  <\collection>
    ...
    <associate|alternative-reachedby|<tuple|1.13|3>>
    ...
    <associate|auto-16|<tuple|<with|mode|<quote|math>|\<bullet\>>|15>>
    <associate|auto-17|<tuple|21|16>>
    ...
    <associate|bib-bader2005dimensions|<tuple|1|15>>
    <associate|bib-balkenius1991nonmonotonic|<tuple|2|15>>
    <associate|bib-belle2021logic|<tuple|3|15>>
    <associate|bib-blutner2004nonmonotonic|<tuple|4|15>>
    <associate|bib-browne2001connectionist|<tuple|5|15>>
    <associate|bib-gabbay1994temporal|<tuple|6|15>>
    <associate|bib-garcez2001symbolic|<tuple|7|15>>
    <associate|bib-garcez2008neural|<tuple|8|15>>
    ...
    <associate|thm:prop-props|<tuple|1.15|4>>
    <associate|thm:reach-props|<tuple|1.14|3>>
